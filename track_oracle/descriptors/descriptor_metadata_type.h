...
typedef struct descriptor_metadata_type
{
  double gsd;
...
std::ostream& operator<<( std::ostream& os, const descriptor_metadata_type& );
std::istream& operator>>( std::istream& is, descriptor_metadata_type& );
