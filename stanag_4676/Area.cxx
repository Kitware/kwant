...
VBL_SMART_PTR_INSTANTIATE(STANAG_4676::Area);
...
::fromXML(const TiXmlElement* elem, int* error_count)
{
  ...
  if (type)
  {
    STANAG_4676_FROMXML_DOWNCAST(elem, type, CircularArea)
    STANAG_4676_FROMXML_DOWNCAST(elem, type, PolygonArea)
