...
namespace kwant {
  ...
  {
  private:
    typedef std::map< track_handle_type, track_handle_list_type >::const_iterator p2it;

    std::map< track_handle_type, per_track_phase3_hadwav > mitre_tracks;
    std::map< track_handle_type, per_track_phase3_hadwav > mitre_targets;
  ...
  public:
    ...
    const std::map< track_handle_type, per_track_phase3_hadwav >& get_mitre_track_stats() const;
    const std::map< track_handle_type, per_track_phase3_hadwav >& get_mitre_target_stats() const;
  };
